...
/dev/block/platform/msm_sdcc.1/by-name/system       /system         f2fs    ro,noatime,nosuid,nodev,nobarrier,discard,nodiratime,inline_xattr,inline_data,inline_dentry          wait,check
/dev/block/platform/msm_sdcc.1/by-name/system       /system         ext4    ro,barrier=0                                                                                         wait
/dev/block/platform/msm_sdcc.1/by-name/cache        /cache          f2fs    rw,noatime,nosuid,nodev,nobarrier,discard,nodiratime,inline_xattr,inline_data,inline_dentry          wait,check
...
/dev/block/platform/msm_sdcc.1/by-name/userdata     /data           f2fs    rw,noatime,nosuid,nodev,nobarrier,discard,nodiratime,inline_xattr,inline_data,inline_dentry          wait,check,encryptable=/dev/block/platform/msm_sdcc.1/by-name/encrypt
